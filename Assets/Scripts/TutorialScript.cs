...
public class TutorialScript : MonoBehaviour
{
    ...
    void Start()
    {
        tutorials = new List<Tutorial>
        {
            ...
            new Tutorial("Your character has hunger, health, happiness, energy and money stats. Goal of the game is to maintain all these statistics while managing your money. You have to play the game according to the character profile you have chosen.", tutorialImages[1]),
            new Tutorial("Each location has different choices that you can choose which can affect your statistics. Some locations are only open at certain times.", tutorialImages[2]),
            ...
            new Tutorial("Random events might appear as well as you play the game.", tutorialImages[4]),
            ...
            new Tutorial("After about a month, your stats will be calculated and star ratings will be given to you.", tutorialImages[6]),
            new Tutorial("The game autosaves your profile after every decision, which can be accessed through the load game in main menu. Remember, consistency is key! While managing your money is important, you should also strive to maintain your other statistics. Good luck and have fun!", tutorialImages[7]),
        };
